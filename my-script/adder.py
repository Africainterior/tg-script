...
print (cy+"Coded by Ahadu, Ethiopia")
print (cy+"For more tools join my group https://t.me/One_LoveZ")
...
for user in users:
    ...
    try:
        ...
        print("Getting Flood Error.hacking is being terminated know.tray again after 15-30 minutes later")
        print("Waiting {} seconds".format(SLEEP_TIME_2))
        time.sleep(SLEEP_TIME_2)
    except UserPrivacyRestrictedError:
        print("The user is alredey in your group so hacking process is .Skipping")
